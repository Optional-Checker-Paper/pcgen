...
//					.getFormatManager(context).get();
		...
		@SuppressWarnings("optional:method.invocation") // call sequencing : the value of scope.getFormatManager(context) is checked for empty earlier (see lines 96 to 101 of this file in the method allowArgs).
